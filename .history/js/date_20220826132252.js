...
console.log(now.toLocaleDateString("vi-VI")); // 26/8/2022
console.log(now.toISOString()); // 2022-08-26T06:09:03.613Z

const myTime = new Date("Fri Aug 26 2022 13:11:24 GMT+0700 (Giờ Đông Dương)");
