...
// isNaN( không phải là số ) Kiểm tra xem cái chuỗi đó có phải là số hay không (true, flase)
// Tự động biến chuỗi số thành số
console.log(isNaN("ssss"));
console.log(isNaN("1234")); // 1234

//Number.isNaN giá trị chuyền vào phải là NaN và kiểu dữ liệu phải là number (true, false)
